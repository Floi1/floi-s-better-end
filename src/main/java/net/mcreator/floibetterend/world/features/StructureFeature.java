package net.mcreator.floibetterend.world.features;
...
import net.mcreator.floibetterend.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, FloiBetterEndMod.MODID);
